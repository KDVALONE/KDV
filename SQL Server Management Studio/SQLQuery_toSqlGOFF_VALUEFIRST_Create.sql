CREATE DATABASE BD_SQLGOFF_VALUEFIRST;
GO
 -- DROP DATABASE BD_SQLGOFF_VALUEFIRST;;
 -- GO
...
CREATE TABLE SALESREPS
 ...
 ALTER TABLE ORDERS
  ...
  FOREIGN KEY (MFR, PRODUCT)
   REFERENCES PRODUCTS
    ON DELETE NO ACTION; --- RESTRICT ИЗ СТАНДАРТА DB2 В SQL НАЗЫВАЕТСЯ NO ACTION, ПРИ УДАЛЕНИИ ИЗМЕНЕНИЯ НЕ ПРОИСХОДИТ
  GO

 --ADD VALUES
 -- отменяет ограничения в таблице
 ...
 (2107, 'Ace International', 110, $35000.000),
 ...
 GO
ALTER TABLE CUSTOMERS WITH NOCHECK CHECK CONSTRAINT ALL


-- отменяет ограничения в таблице
 ALTER TABLE SALESREPS  NOCHECK CONSTRAINT ALL

 INSERT INTO SALESREPS
 VALUES
 (105, 'Bill Adams', 37, 13, 'Sales Rep', '2006-02-12', 104,  $350000.00, $367911.00),
 (109, 'Mary Jones', 31, 11, 'Sales Rep', '2007-10-12', 106, $300000.00, $392725.00), -- 12-OCT-89
 ...
 (101, 'Dan Roberts', 45, 12, 'Sales Rep', '2004-10-20', 104, $300000.00, $305673.00),--20-OCT-86
 (110, 'Tom Snyder', 41, NULL, 'Sales Rep', '2008-01-13', 101, NULL, $75985.00),
 (108, 'Larry Fitch', 62, 21, 'Sales Mgr', '2007-10-12', 106, $350000.00, $361865.00),--12-OCT-89
 (103, 'Paul Cruz', 29, 12, 'Sales Rep', '2005-03-01', 104, $275000.00, $286775.00),--01-MAR-87
 (107, 'Nancy Angelli', 49, 22, 'Sales Rep', '2006-11-14', 108, $300000.00, $186042.00)
 GO
 ALTER TABLE SALESREPS WITH NOCHECK CHECK CONSTRAINT ALL

 
 -- отменяет ограничения в таблице
 ALTER TABLE OFFICES  NOCHECK CONSTRAINT ALL
 ...
 GO
 ALTER TABLE OFFICES WITH NOCHECK CHECK CONSTRAINT ALL
 ...
 ALTER TABLE PRODUCTS  NOCHECK CONSTRAINT ALL
  	...
  	INSERT INTO PRODUCTS -- сверить цифры
 VALUES
 ...
 ('QSA', 'Xk48', 'Reducer', $134.00, 203), --Xk47 ? 
 ...
 ('REI', '2A44G', 'Hinge Pin', $350.00, 14)
 GO
 ALTER TABLE PRODUCTS WITH NOCHECK CHECK CONSTRAINT ALL


 -- отменяет ограничения в таблице ORDERS, так как по FК она связана с PRODUCTS, то 
 ALTER TABLE ORDERS NOCHECK CONSTRAINT ALL  

 INSERT INTO ORDERS -- сверить цифры
 VALUES
 ...
 (112968, '2007-10-12', 2102, 101, 'ACI', '41004', 34, $3978.00), --12-OCT-89
 ...
 (112979, '2007-10-12', 2114, 102, 'ACI', '4100Z', 6, $15000.00),-- 12-OCT-89
 ...
 (112975, '2007-10-12', 2111, 103, 'REI', '2A44G', 6, $2100.00), -- 12-OCT-89
