...
public class Main {
    ...
    public static void main1() 
    {
        ...
        int[][] rezult = solvePuzzle (clues);
        
         for (int i = 0; i < N; i++) 
         {
             for (int j = 0; j < N; j++) 
             {
                 System.out.println(rezult[i][j]);
    ...
    /**
     Checks if there's any duplicate numbers in the row and col
         @param board, Current state of the game board
    ...
    static boolean hasDuplicates(int[][] board, int row, int col, int guess) {
