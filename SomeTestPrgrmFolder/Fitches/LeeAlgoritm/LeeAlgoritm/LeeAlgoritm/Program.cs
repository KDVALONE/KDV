...
namespace LeeAlgoritm
{
    ///// <summary>
    //  алгоритм ЛИ, для подсчета наиболее короткого пути к  обьекту на сетке. 
    // тут алгоритм нумеровки двойнова массива, 
    // для полной реализации добавить  выбор точки в которую нужно придти из точки 0.
      // и от максимального числа движение проходит до ячейки со значениме 0. по убыванию значений.
    ///// </summary>
    class Program
    {
