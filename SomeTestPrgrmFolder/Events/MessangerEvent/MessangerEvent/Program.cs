...
/// </summary>
    ...
    class MailMessanger
    {
        ...
        // 4. Обьявляем метод уведомляющий о событии подписчиков, принимающий мой тип параметров
        ...
        // 5. Определяем метод ответсвенный за преобразование входных пользовательских данных о сообщении, в мой подходящий тип для параметров события
