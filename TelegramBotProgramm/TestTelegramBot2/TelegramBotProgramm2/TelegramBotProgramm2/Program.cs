...
namespace TelegramBotProgramm2
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int ChatID = 115774926; // Я:115774926 Лена: 194716982
            ...
            //m.Getme(); //метод проврки запроса, возвращает (бот ли это,имя бота, bot ID )
            // m.SendMessage("Ну привет", ChatID); //отправим сообщение(текст отправки и ID чата)
            // m.ForwardMessage(ChatID, ChatID, 16);//перешлем сообщение(откуда,куда,ID сообщения)
